      ...
      {wizardStep === "source" ? (
        <div className="wizard-panel">
          ...
          >
            ...
            >
              <p className="wizard-meta" style={{ margin: 0 }}>
                Optional one-time code used to enroll this installation for
      ...
      {wizardStep === "paths" ? (
        <div className="wizard-panel">
          ...
          <details className="advanced-options">
            <summary className="advanced-summary">
              Advanced: Override Minecraft Directory
            </summary>
            <div
              className="advanced-content"
            ...
            >
              <p
                className="wizard-meta"
                style={{ marginBottom: "4px", marginTop: 0 }}
              >
                By default, the sync tool automatically targets the default
                configuration folder of the launcher you selected above. Use
                this option ONLY if you want to override that behavior and force
                a custom absolute data path (like a portable USB drive or
        ...
        <div className="wizard-panel">
          ...
          <details className="advanced-options">
            ...
            <div className="advanced-content">
              ...
              <p className="wizard-meta">
                Managed sync dir:{" "}
                {versionReadiness?.managedMinecraftDir ?? "--"}
              </p>
              <p className="wizard-meta">
              ...
              <p className="wizard-meta">
                ...
                {versionReadiness?.managedVersionPresent
                  ? "present"
                  : "missing"}
                )
              </p>
      ...
      {wizardStep === "sync" ? (
        <div className="wizard-panel">
          ...
          <p className="wizard-meta" style={{ fontSize: "0.85rem" }}>
            Profile contains <strong>{catalog?.mods.length ?? 0}</strong> mods
            and <strong>{catalog?.configs.length ?? 0}</strong> configs.
          </p>
