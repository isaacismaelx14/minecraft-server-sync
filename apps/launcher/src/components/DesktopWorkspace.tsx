...
export function DesktopWorkspace({
  ...
  const primaryButtonClass = `${baseButtonClass} border-0 bg-[linear-gradient(135deg,var(--color-brand-primary),var(--color-brand-accent))] bg-[length:200%_200%] text-white shadow-[0_4px_15px_var(--color-brand-indigo-shadow)] hover:-translate-y-px hover:animate-[gradientShift_3s_ease_infinite] hover:shadow-[0_6px_20px_var(--color-brand-indigo-shadow)] active:translate-y-px`;
